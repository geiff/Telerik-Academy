...
namespace PersonForm
{
    public partial class FormData : Form
    {
        ...
        {
            if (Validation.ValidationForm(textBoxName.Text, textBoxBirthDate.Text, textBoxEmail.Text, textBoxPhoneNumber.Text))
            {
                try
                {
            ...
            {
                MessageBox.Show(Validation.ValidationString(textBoxName.Text, textBoxBirthDate.Text, textBoxEmail.Text, textBoxPhoneNumber.Text));
            }
        }      
    }
}